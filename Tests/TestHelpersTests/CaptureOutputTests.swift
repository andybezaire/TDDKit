...
private func captureOutput<P, O>(for publisher: P, droppingFirst dropCount: Int = 1, when block: () async -> Void) async -> [O] where P: Publisher, P.Failure == Never, P.Output == O {
